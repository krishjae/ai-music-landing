      ...
      <StyledWrapper>
        <div className="main_wrapper">
          <div className="main">
            ...
            <div className="tv">
              <div className="cruve">
                <svg className="curve_svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 189.929 189.929">
...
const PageWrapper = styled.div`
  ...
  background: linear-gradient(to bottom right, #090E24, #140D26);
`;

const StyledWrapper = styled.div`
/* Entire 404 TV styles go here */
/* Please copy and paste the full TV styles from your CSS here */
`;
