...
export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center text-center min-h-screen w-full px-4 pt-20">
      ...
      <button className="bg-gradient-to-r from-purple-600 to-green-400 text-white py-3 px-6 rounded-full shadow-lg hover:scale-105 transition transform duration-200">
        Get Started
      </button>
    </section>
  );
